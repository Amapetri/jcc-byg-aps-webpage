...
export const metadata: Metadata = {
  title: {
    default: "JCC Byg ApS — {{TAGLINE}}",
    template: "%s | JCC Byg ApS",
  },
  description: "JCC Byg udfører alt indenfor tømrerarbejde, uanset om det er småopgaver, tilbygning, ombygning eller totalentreprise.",
  metadataBase: new URL(SITE_URL),
  openGraph: {
    type: "website",
    siteName: "JCC Byg ApS",
  },
  twitter: {
